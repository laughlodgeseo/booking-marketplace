...
const COPY: Record<AppLocale, OwnerProcessCopy> = {
  en: {
    eyebrow: "Process",
    title: "Simple onboarding from first call to go-live",
    subtitle:
      "Each step has a clear output so you always know what happens next.",
    ...
    steps: [
      {
        ...
        desc: "We review your location, unit type, and setup level.",
        timeline: "Day 1",
        deliverable: "Initial recommendation",
        Icon: ClipboardList,
      },
      {
        n: "2",
        title: "Scope and pricing",
        desc: "We define services, responsibilities, and commercial terms.",
        timeline: "Day 2-4",
      ...
      },
      {
        ...
        desc: "We prepare listing setup, media, policies, and operations workflows.",
        timeline: "Day 4-10",
      ...
      },
      {
        ...
        desc: "Your listing goes live and we keep optimizing pricing, occupancy, and service.",
        timeline: "Day 10+",
