...
const COPY: Record<AppLocale, OwnersHeroCopy> = {
  en: {
    eyebrow: "For owners",
    title: "Grow your Dubai rental with less stress",
    description:
      "We manage pricing, bookings, and day-to-day operations so your property stays booked and guest-ready. You choose the service level, and we deliver it with premium standards.",
    signupCta: "Start vendor onboarding",
    consultCta: "Book a quick owner call",
    comparePrograms: "See programs",
    viewServices: "See services",
    reviewPricing: "See pricing",
    locationTag: "Business Bay, Dubai",
    locationNote: "One of Dubai's strongest short-stay areas for business and leisure guests.",
    prioritiesEyebrow: "Built for owners",
    prioritiesTitle:
      "Built for steady occupancy, better reviews, and clear monthly reporting.",
    readinessHint: "Most properties go live in 7-14 days, based on property condition and document readiness.",
    supportLabels: {
      demandZones: "High-demand areas",
      stayStandards: "Premium standards",
      guestExperience: "Guest comfort",
    },
    supportAlt: {
    ...
    highlights: [
      {
        ...
        desc: "Rates are adjusted for season, events, and real demand in Dubai.",
        Icon: TrendingUp,
      },
      {
        title: "24/7 guest support",
        desc: "Guests get fast help any time, which protects reviews and owner peace of mind.",
        Icon: CalendarCheck2,
      },
      {
        title: "Reliable operations",
        desc: "Cleaning, inspections, and issue handling are linked to booking milestones.",
        Icon: ShieldCheck,
      },
      {
        title: "Clear owner visibility",
        desc: "You can track tasks, progress, and exceptions across every property.",
        Icon: BadgeCheck,
      },
    ],
  },
